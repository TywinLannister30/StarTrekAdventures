...
public static class SpaceframeSelector
{
    ...
    private static readonly ICollection<Spaceframe> Spaceframes = new List<Spaceframe>
    {
        new()
        {
            ...
            NamingConventions = "Freedom-class vessels utilized names associated with notable individuals throughout Earth history, often revolutionaries and leaders.",
        ...
        new()
        {
            ...
            NamingConventions = "NX-class vessels utilize names from famous Earth ships—both maritime vessels and early spacecraft—often names with long legacies. NX-class vessels have registries that begin with NX, and are numbered sequentially.",
            SuggestedMissionProfiles = new List<string>
            {
        ...
        new()
        {
            ...
            NamingConventions = "Walker-class vessels are named after early aviation heroes of Earth and other founding members of the Federation, and mythical ideas of flight. Valkyrie, Thunderbird, and Vimana are all examples. Registry numbers of Walker-class vessels range from 1200 to 1249.",
            SuggestedMissionProfiles = new List<string>
            {
                MissionProfileName.MultiroleExplorer,
                MissionProfileName.PathfinderAndReconnaissanceOperations,
        ...
        new()
        {
            ...
            NamingConventions = "Pioneer-class vessels are named using synonyms for pioneers, such as Trailblazer, Wanderer, Pathfinder, and Explorer. NCC numbers range from 1500-1599.",
            SuggestedMissionProfiles = new List<string>
            {
        ...
        new()
        {
            ...
            NamingConventions = "Constitution-class vessels are often named after famous Earth navy vessels and pre-warp spacecraft. Registry numbers range between 1700 and 1799, though there are exceptions.",
            SuggestedMissionProfiles = new List<string>
            {
        ...
        new()
        {
            ...
            NamingConventions = "Three known Crossfieldclass vessels were produced, with no pattern of naming conventions among them.",
            SuggestedMissionProfiles = new List<string>
            {
                MissionProfileName.TechnicalTestbed,
            },
        ...
        new()
        {
            ...
            NamingConventions = "Miranda-class vessels take names from nearly every aspect of naval traditions from across the Federation. Empress Sh’Thia XI, Repulse, and Lake Baikal are examples. Registry numbers range as low as 1850 and continue upward.",
            SuggestedMissionProfiles = new List<string>
            {
                MissionProfileName.MultiroleExplorer,
                MissionProfileName.ScientificAndSurveyOperations,
        ...
        new()
        {
            ...
            NamingConventions = "Oberth-class vessels are often named after physicists from across the Federation. Newton, Hawking and Von Neumann are examples.",
            SuggestedMissionProfiles = new List<string>
            {
                MissionProfileName.CrisisAndEmergencyResponse,
                MissionProfileName.ScientificAndSurveyOperations,
        ...
        new()
        {
            ...
            NamingConventions = "Columbia-class starships are often named after crewed vehicles from the history of space exploration across Federation worlds. NCC numbers range from 2200-2299.",
            SuggestedMissionProfiles = new List<string>
            {
                MissionProfileName.PathfinderAndReconnaissanceOperations,
        ...
        new()
        {
            ...
            NamingConventions = "Constellation-class vessels are named after astronomers, terms associated with astronomy, constellations, or mythological sky deities. Cassiopeia, Nyx, and Ratri are examples.",
            SuggestedMissionProfiles = new List<string>
            {
                MissionProfileName.CrisisAndEmergencyResponse,
                MissionProfileName.MultiroleExplorer
        ...
        new()
        {
            ...
            NamingConventions = "Excelsior-class vessels take names from concepts of exploration, achievement, and great leaders from across the Federation; many are also named after famous ships from previous generations. Forrest, Archer, and Victory are all examples.",
            SuggestedMissionProfiles = new List<string>
            {
                MissionProfileName.MultiroleExplorer,
                MissionProfileName.StrategicAndDiplomaticOperations,
        ...
        new()
        {
            ...
            NamingConventions = "California-class vessels are named after locations found within the North American state of California. Burbank, Fresno, and West Covina are examples.",
            SuggestedMissionProfiles = new List<string>
            {
        ...
        new()
        {
            ...
            NamingConventions = "Galaxy-class vessels take their names from many different cultures across the Federation. Most are associated with exploration and scientific discovery. Odyssey, Hanson, and Surok are examples. The U.S.S. Galaxy was NX/NCC-70637, and all vessels of the class have registries higher than this, barring the Enterprise, which used its own legacy number.",
            SuggestedMissionProfiles = new List<string>
            {
        ...
        new()
        {
            ...
            NamingConventions = "Nebula-class vessels take their names from across the Federation, based on famous ships from the past. Bennion, Beagle, and Golden Hind are examples. Most Nebula-class vessels have registry numbers over 60000; a few have much lower numbers, indicating production at smaller, less-used shipyards.",
            SuggestedMissionProfiles = new List<string>(),
            Traits = new List<string>
            {
                "Federation Starship",
        ...
        new()
        {
            ...
            NamingConventions = "Akira-class vessels are often named after famed or fictional warriors or fighting vessels, particularly those who stood against impossible odds, or after places where such battles were fought. Thermopylae, Gawain, and Argo are some examples.",
            SuggestedMissionProfiles = new List<string>
            {
        ...
        new()
        {
            ...
            NamingConventions = "Nova-class vessels take names from astronomical and astrological terms from the many languages of the Federation, and place names from the worlds that manufacture the spaceframes. Nova-class starships use registry numbers that begin in the 72300s.",
            SuggestedMissionProfiles = new List<string>
            {
                MissionProfileName.CrisisAndEmergencyResponse,
                MissionProfileName.PathfinderAndReconnaissanceOperations,
        ...
        new()
        {
            ...
            NamingConventions = "Defiant-class starships are often named for adjectives in the languages of the Federation associated with honorable combat and heroism. Courageous, Dauntless, and Resolute are examples.",
            SuggestedMissionProfiles = new List<string>
            {
        ...
        new()
        {
            ...
            NamingConventions = "Intrepid-class vessels take names from mythology and space exploration across the Federation. Pathfinder, Odysseus, and Bellerophon are some examples.",
            SuggestedMissionProfiles = new List<string>
            {
                MissionProfileName.PathfinderAndReconnaissanceOperations,
                MissionProfileName.ScientificAndSurveyOperations,
        ...
        new()
        {
            ...
            NamingConventions = "Sovereign-class vessels are often named after famous ships from Federation history. Farragut, Wasp, and Shran are all examples.",
            SuggestedMissionProfiles = new List<string>
            {
                MissionProfileName.StrategicAndDiplomaticOperations,
                MissionProfileName.ScientificAndSurveyOperations,
        ...
        new()
        {
            ...
            NamingConventions = "Luna-class vessels are named after moons, with the earliest vessels in the class using the names of moons from the Sol system. Deimos, Uriel, and Oberon are examples. Registry numbers in the 80100s are commonplace.",
            SuggestedMissionProfiles = new List<string>
            {
                MissionProfileName.MultiroleExplorer,
                MissionProfileName.PathfinderAndReconnaissanceOperations,
        ...
        new()
        {
            ...
            NamingConventions = "Constitution III-class vessels are mostly named after previous Starfleet vessels, often the ones which contributed components to the new design, such as the Titan.",
            SuggestedMissionProfiles = new List<string>
            {
                MissionProfileName.CrisisAndEmergencyResponse,
                MissionProfileName.MultiroleExplorer,
        ...
        new()
        {
            ...
            NamingConventions = "The Odyssey is named in honor of both Odysseus’s original daring voyage and other Starfleet ships. As Starfleet’s flagship class of the 25th century, other Odyssey-class ships inherit names from renowned vessels.",
            SuggestedMissionProfiles = new List<string>
            {
                MissionProfileName.CrisisAndEmergencyResponse,
                MissionProfileName.Flagship,
        ...
        new()
        {
            ...
            NamingConventions = "Sagan-class vessels are commonly named after terms relating to exploration, and after notable figures in space science and exploration. The first vessel of the class was the U.S.S. Stargazer (NCC-82893). Pioneer, Hathaway, and Hubble are other examples.",
            SuggestedMissionProfiles = new List<string>
            {
                MissionProfileName.MultiroleExplorer,
                MissionProfileName.PathfinderAndReconnaissanceOperations,
        ...
        new()
        {
            ...
            NamingConventions = "Klingon vessels have little in the way of standard naming conventions. Each House has its own traditions, as does the KDF.",
            SuggestedMissionProfiles = new List<string>
            {
                MissionProfileName.Battlecruiser,
                MissionProfileName.StrategicAndDiplomaticOperations,
        ...
        new()
        {
            ...
            NamingConventions = "T’Liss warbirds are named after powerful senators the navy wished to gain favor with, and concepts of martial prowess.",
            SuggestedMissionProfiles = new List<string>
            {
                MissionProfileName.EspionageOrIntelligence,
                MissionProfileName.PathfinderAndReconnaissanceOperations,
        ...
        new()
        {
            ...
            NamingConventions = "D’Deridex names include famous starship commanders from Romulan history and important Imperial worlds.",
            SuggestedMissionProfiles = new List<string>
            {
                MissionProfileName.Battlecruiser,
                MissionProfileName.MultiroleExplorer,
        ...
        new()
        {
            ...
            NamingConventions = "Mogai-class vessels take their names from sea birds found across the Empire, as well as influential families who lost children during the Dominion War.",
            SuggestedMissionProfiles = new List<string>
            {
                MissionProfileName.Battlecruiser,
                MissionProfileName.EspionageOrIntelligence,
        ...
        new()
        {
            Name = SpaceframeName.Galor,
            LaunchYear = 2348,
            Overview = "Designed and built during the middle of the long Federation-Cardassian War of the mid-24th century, the Galor-class cruiser was meant to be the answer to the effective Starfleet Ambassador- and Excelsior-class vessels common along the frontier. Sacrifices in the design had to be made as the Union lacked the same shipbuilding facilities as the Federation. These cruisers were rarely seen alone, and often in small squadrons of three to five. Through two wars, the Galor and her sister classes were the backbone of the Cardassian Central Command.",
            Capabilities = "Simplicity, ease of maintenance and construction, and having as small of a logistics need as possible were all important when the Galor was designed. These cruisers do not have a torpedo system installed, as Central Command felt wasting antimatter on weapons would limit the number of starships they could produce. Instead, this class utilized two separate energy weapon systems: phaser arrays spread across the outer hull and a heavy forward mounted disruptor emitter. ",
            RefitsAndVariants = "Central Command issued orders after the class came into service to improve the weapon systems with any captured technology. During the Dominion War, this focus changed to improvements to the outer hull and warp propulsion.",
            NamingConventions = "Galor class cruisers take their names from famous war leaders of Cardassia’s past, important cities on Cardassian Prime, and war heroes.",
            SuggestedMissionProfiles = new List<string>
            {
                MissionProfileName.EspionageOrIntelligence,
                MissionProfileName.PathfinderAndReconnaissanceOperations,
            ...
            Systems = new StarshipSystems
            {
                Comms = 8, Computers = 8, Engines = 9, Sensors = 7, Structure = 8, Weapons = 9
            },
            Departments = new Departments
            {
                Command = 1, Engineering = 1, Security = 1
            ...
            {
                StarshipWeaponName.PhaserBanks,
                StarshipWeaponName.DisruptorSpinalLance
            },
            TractorBeamStrength = 3,
            Weight = 0
        },
        ...
        new()
        {
            Name = SpaceframeName.DKora,
            LaunchYear = 2350,
            Overview = "By the mid-24th century, the Ferengi Alliance had expanded across multiple sectors. The vast range of societies and species it encountered meant the Alliance, while heavily centralized in the Ferenginar system, had to maintain the ever- growing trade lanes as well as ensure the markets would stay linked to the homeworld, through free trade or by force. The Ferengi Congress of Economic Advisors levied a tax on all non-Ferengi economic activity to begin construction of the D’Kora class marauder. Ferenginar had no active force like Starfleet, but the Congress would provide a letter of marque to any free trader willing to captain and crew a vessel for the good of the Alliance. D’Kora marauders quickly became a symbol of the Ferengi Alliance across the Alpha and Beta Quadrants, feared for their weaponry and the economic exploitation that would occur in their presence.",
            Capabilities = "The D’Kora needed a large amount of its internal volume as mission adaptable space, but the vast majority of commanding officers used this space as cargo storage. The standard production vessel included a unique system tied to the vessel’s warp coils. If these warp coils were purposely put out of alignment and charged, the plasma could be discharge as a powerful electromagnetic pulse, disrupting a hostile ship’s systems and defensive shielding, and, in a best case, render the other ship powerless and available for acquisition.",
            RefitsAndVariants = "The Ferengi Alliance stayed out of the Dominion War except for arms sales to both sides. Trading in war zones can be hazardous to the safety of one’s ship, thus the Alliance put forth a rare regulation to improve the marauder’s shielding, structural integrity fields, and other safety equipment.",
            NamingConventions = "D’Kora-class maruaders take names from their commanding officers or their loved ones, or the limited liability companies they are owned by.",
            SuggestedMissionProfiles = new List<string>
            {
                MissionProfileName.EspionageOrIntelligence,
                MissionProfileName.PathfinderAndReconnaissanceOperations,
            ...
            Systems = new StarshipSystems
            {
                Comms = 9, Computers = 8, Engines = 10, Sensors = 9, Structure = 10, Weapons = 7
            },
            Departments = new Departments
            {
                Command = 1, Engineering = 1, Science = 1
            },
            Weapons = new List<string>
            {
                StarshipWeaponName.PhaserBanks,
