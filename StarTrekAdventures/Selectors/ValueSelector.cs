...
public class ValueSelector : IValueSelector
{
    ...
    private static readonly List<Value> Values = new()
    {
        ...
        new Value { Name = "Can I make peace with what my people did to the place I was raised?", TraitRequirement = SpeciesName.Bajoran, Weight = 5 },
        new Value { Name = "I did things that nobody should, to defend my home", TraitRequirement = SpeciesName.Bajoran, Weight = 5 },
        ...
        new Value { Name = "Be careful of who you trust with your secrets", TraitRequirement = SpeciesName.Cardassian, Weight = 5 },
        ...
        new Value { Name = "It is easy for people from prosperous worlds to judge us for where necessity brought us", TraitRequirement = SpeciesName.Cardassian, Weight = 5 },
        ...
        new Value { Name = "75th rule of acquisition – home is where the heart is, but the stars are made of latinum", TraitRequirement = SpeciesName.Ferengi, Weight = 10 },
        ...
        new Value { Name = "If you can’t see the cost of your actions, you’re not looking hard enough", TraitRequirement = SpeciesName.Ferengi, Weight = 5 },
        ...
        new Value { Name = "If something is important, it’s worth debating and considering deeply and thoroughly", TraitRequirement = SpeciesName.XindiAquatic, Weight = 10, Source = BookSource.SpeciesSourcebook },
        new Value { Name = "If you want to convince me, show me the proof: don’t just tell me", TraitRequirement = SpeciesName.XindiAquatic, Weight = 10, Source = BookSource.SpeciesSourcebook },
        ...
        new Value { Name = "A law that stops me helping people is no law I wish to obey", Weight = 1 },
        ...
        new Value { Name = "Everyone wears many faces, and if you don’t, you’re putting yourself at a disadvantage", Weight = 1 },
        ...
        new Value { Name = "I help those who have no one else", Weight = 1 },
        ...
        new Value { Name = "I will do whatever it takes to protect my home and my people", Weight = 1 },
