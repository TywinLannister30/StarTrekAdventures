...
namespace StarTrekAdventures.Selectors.Version1
{
    public class ValueSelector
    {
        ...
        private static readonly List<Value> Values = new List<Value>
        {
            ...
            new Value { Name = "State – Family – Self", TraitRequirement = SpeciesName.Cardassian, Weight = 10 },
            ...
            new Value { Name = "Safety in Numbers", TraitRequirement = SpeciesName.Denobulan, Weight = 10 },
            ...
            new Value { Name = "1st Rule of Acquisition — Once You Have Their Money, Never Give It Back", TraitRequirement = SpeciesName.Ferengi, Weight = 5 },
            new Value { Name = "6th Rule of Acquisition – Never Let Family Stand in the Way of Profit", TraitRequirement = SpeciesName.Ferengi, Weight = 5 },
            new Value { Name = "31st Rule of Acquisition – Never Make Fun of a Ferengi’s Mother", TraitRequirement = SpeciesName.Ferengi, Weight = 5 },
            new Value { Name = "48th Rule of Acquisition — The Bigger the Smile, the Sharper the Knife", TraitRequirement = SpeciesName.Ferengi, Weight = 5 },
            new Value { Name = "74th Rule of Acquisition – Knowledge Equals Profit", TraitRequirement = SpeciesName.Ferengi, Weight = 5 },
            new Value { Name = "94th Rule of Acquisition – Females and Finances Don’t Mix", TraitRequirement = SpeciesName.Ferengi, Weight = 5 },
            new Value { Name = "98th Rule of Acquisition – Every Man Has His Price", TraitRequirement = SpeciesName.Ferengi, Weight = 5 },
            new Value { Name = "168th Rule of Acquisition – Whisper Your Way to Success", TraitRequirement = SpeciesName.Ferengi, Weight = 5 },
            new Value { Name = "190th Rule of Acquisition – Hear All, Trust Nothing", TraitRequirement = SpeciesName.Ferengi, Weight = 5 },
            new Value { Name = "211th Rule of Acquisition — Employees are the Rungs on the Ladder to Success; Don’t Hesitate to Step On Them", TraitRequirement = SpeciesName.Ferengi, Weight = 5 },
            new Value { Name = "285th Rule of Acquisition – No Good Deed Ever Goes Unpunished", TraitRequirement = SpeciesName.Ferengi, Weight = 5 },
            ...
            new Value { Name = "Today is a Good Day to Die!", TraitRequirement = SpeciesName.Klingon, Weight = 5 },
            ...
            new Value { Name = "All Ideas must Withstand Scrutiny", TraitRequirement = SpeciesName.Tellarite, Weight = 10 },

            new Value { Name = "Four Lifetimes of Adventure", TraitRequirement = SpeciesName.Trill, TalentRequirement = "Joined", Weight = 20 },
            ...
            new Value { Name = "Wisdom is the Beginning of Logic, Not the End", TraitRequirement = SpeciesName.Vulcan, Weight = 5 },
