    ...
    public class UbringingSelector
    {
        ...
        private static readonly List<Upbringing> Upringings = new List<Upbringing>
        {
            new Upbringing {
                ...
                DepartmentChoices = new CharacterDepartments { Conn = 1, Security = 1, Medicine = 1 },
            ...
            new Upbringing {
                ...
                DepartmentChoices = new CharacterDepartments { Command = 1, Engineering = 1, Science = 1 },
            ...
            new Upbringing {
                ...
                DepartmentChoices = new CharacterDepartments { Command = 1, Conn = 1, Security = 1 },
            ...
            new Upbringing {
                ...
                DepartmentChoices = new CharacterDepartments { Conn = 1, Engineering = 1, Science = 1, Medicine = 1 },
