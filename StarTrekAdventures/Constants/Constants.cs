...
namespace StarTrekAdventures.Constants
{
    ...
    public static class RoleName
    {
        ...
        public const string CombatEngineer = "Combat Engineer";
        public const string DiplomaticAttache = "Diplomatic Attache";
        public const string ExecutiveOfficer = "Executive Officer";
        public const string Expert = "Expert";
        public const string ExplosiveOrdnanceExpert = "Explosive Ordnance Expert";
        public const string FieldMedic = "Field Medic";
        ...
        public const string HeavyWeaponSpecialist = "Heavy Weapon Specialist";
        ...
        public const string SquadLeader = "Squad Leader";
