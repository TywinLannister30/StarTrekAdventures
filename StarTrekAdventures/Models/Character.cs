...
namespace StarTrekAdventures.Models
{
    public class Character
    {
        public Character()
        {
            ...
            Departments = new CharacterDepartments
            {
                Command = 1,
                Conn = 1,
                Engineering = 1,
        ...
        public CharacterDepartments Departments { get; set; }
        ...
        internal void AdjustAttributesForEnvironment(Environment environment)
        {
        ...
        internal void AdjustDepartmentsForEnvironment(Environment environment)
        {
            var choices = new List<string>();
        ...
        internal void AddFocuses(List<string> focusesAvailable, int numToChoose)
        {
            var choices = new List<string>();
        ...
        internal void AdjustDisciplinesForCareerEvent(CareerEvent careerEvent)
        {
            ...
            {
                var departments = typeof(CharacterDepartments).GetProperties();
